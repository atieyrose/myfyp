    ...
    <head>
        ...
        <style>
            ...
            <body>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <a href="employeeServlet?action=emplist" class="card" style="text-decoration: none;
                            color: black;">
                            <div class="card-body custom-color">
                                <h5 class="card-title">Employee</h5>
                                <i class="fa fa-address-card fa-lg icon-center" style="color: #00ffcc;">
                                </i>
                    ...
                    <div class="col-md-3">
                        <a href="attendancesList.jsp" class="card" style="text-decoration: none;
                            color: black;">
                            <div class="card-body custom-color">
                    ...
                    <div class="col-md-3">
                        <a href="productsServlet?action=prodlist" class="card" style="text-decoration: none;
                            color: black;">
                            <div class="card-body custom-color">
