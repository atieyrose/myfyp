...
<html>
    ...
    <body>
        ...
        <div class="container col-md-10">
            ...
            <td><input type="hidden" name="amount[]" value="${amount.toFixed(2)}">${amount.toFixed(2)}</td>
            <td><button class="btn btn-danger btn-sm remove-item">Remove</button></td>
        `;

                                saleList.appendChild(newRow);

                                // Increment sale index for the next item
                                saleIndex++;
